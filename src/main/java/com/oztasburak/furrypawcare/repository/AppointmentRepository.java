...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    List<Appointment> findByDoctorNameStartAndFinishDate(String doctorName, LocalDate startDate, LocalDate finishDate);
    ...
    @Query(value = "SELECT appointment.* " +
            ...
            "AND " +
            "appointment.appointment_date BETWEEN ?2 AND ?3", nativeQuery = true)
    List<Appointment> findByAnimalNameStartAndFinishDate(String animalName, LocalDate startDate, LocalDate finishDate);
}
